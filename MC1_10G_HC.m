...
for sth = 1:num_simulations
    ...
    X = inputMCXG10_HC((sth-1)*N*T+1:sth*N*T, :);
    Y = inputMCYG10_HC((sth-1)*N*T+1:sth*N*T);
...
fileID1 = fopen('assignment_G10_HC.txt', 'w');
fileID2 = fopen('theta_G10_HC.txt', 'w');
